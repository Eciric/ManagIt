...
public class EventDaoTest {
    ...
    Event event1 = new Event(LocalDateTime.parse("20-12-2020 10:00",formatter),"loading", new ArrayList<Long>(Arrays.asList(2l,3l)),new ArrayList<Long>(Arrays.asList(1l,2l)), new ArrayList<Long>(Arrays.asList(1l)), false);
    Event event2 = new Event(LocalDateTime.parse("05-01-2021 15:00",formatter),"unloading", new ArrayList<Long>(Arrays.asList(2l,3l)),new ArrayList<Long>(Arrays.asList(2l)), new ArrayList<Long>(Arrays.asList()), false);
    Event event3 = new Event(LocalDateTime.parse("15-03-2021 11:30",formatter),"loading", new ArrayList<Long>(Arrays.asList(3l)),new ArrayList<Long>(Arrays.asList(1l)), new ArrayList<Long>(Arrays.asList()), false);
    Event event5 = new Event(LocalDateTime.parse("01-01-2001 10:00",formatter),"T", new ArrayList<Long>(Arrays.asList(1l)),new ArrayList<Long>(Arrays.asList(1l)), new ArrayList<Long>(Arrays.asList(1l)),false);
